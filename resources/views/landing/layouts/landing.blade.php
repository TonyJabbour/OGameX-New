...
<head>
    ...
    <title>{{ config('app.name', 'OGameX') }} - Conquer the Universe</title>
    <meta name="description" content="OGameX - The legendary space strategy game. Build your empire, explore the universe, and conquer your enemies in this epic browser-based MMO.">
...
<body class="landing-page">
    ...
    <nav class="navbar">
        <div class="container">
            <div class="nav-wrapper">
                <a href="/" class="logo">
                    <span class="logo-text">OGameX</span>
                </a>
                <div class="nav-menu">
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="#screenshots" class="mobile-link">Screenshots</a>
        <a href="#about" class="mobile-link">About</a>
        <a href="{{ route('login') }}" class="mobile-link">Login</a>
        <a href="{{ route('register') }}" class="btn btn-primary mobile-cta">Play Now</a>
    </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3 class="footer-title">OGameX</h3>
                    <p class="footer-desc">The ultimate space strategy game. Build your empire and conquer the universe.</p>
                ...
                <div class="footer-section">
                    <h4 class="footer-subtitle">Game</h4>
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} OGameX. All rights reserved. | Version: {{ \OGame\Facades\GitInfoUtil::getAppVersionBranchCommit() ?? '1.0.0' }}</p>
            </div>
        </div>
    </footer>
